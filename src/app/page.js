...
export default function Home() {
    ...
    useEffect(() => {
        fetch(`${process.env.REACT_APP_API_TOKEN}api/v2/certificate-class/`)
            .then((response) => {
                if (!response.ok) {
                ...
                <div className="container-main">
                    <div className={styled.main_content}>
                        ...
                        <div className={`${styled.main_content_get_contact} ${dayMoon ? styled.background_color : ""}`}>
                            ...
                            <Link href="/contact" className={`${styled.main_content_get_contact_btn} ${dayMoon ? styled.main_content_btn_active : ""}`}>Contact Us</Link>
                        </div>
